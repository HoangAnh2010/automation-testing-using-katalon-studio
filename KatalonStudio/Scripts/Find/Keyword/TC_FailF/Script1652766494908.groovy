...
'Xác minh kết quả'
WebUI.verifyElementText(findTestObject('Object Repository/Page_Tuyn dng, tm kim vic lm ti H Ni  Caree_ca541a/h6_Chng ti khng tm thy vic no ph hp vi tm k_69486d'), 
    result)
